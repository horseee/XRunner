...
public class ImageTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    private int selectTextureNum;
    public Thread thread;

    private CubeObject mCube;
    public float xRotate = 90f;
    public float yRotate = 0f;
    public float xScalef = 0.005f;
    public float yScalef = 0.005f;
    public float zScalef = 0.005f;
    
    private float kBuildingScale = 0.5f;
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
            ...
            /*int textureIndex = trackable.getName().equalsIgnoreCase("tarmac") ? 0
                    : 1;
            textureIndex = trackable.getName().equalsIgnoreCase("Image") ? 2
                    : textureIndex;*/
            ...
            if (!mActivity.isExtendedTrackingActive()) {
                Matrix.translateM(modelViewMatrix, 0, 0.0f, 0.0f,
                        0.003f);
                Matrix.scaleM(modelViewMatrix, 0, xScalef,
                        yScalef, zScalef);
            } else {
                Matrix.rotateM(modelViewMatrix, 0, xRotate, 1.0f, 0, 0);
            ...
            if (!mActivity.isExtendedTrackingActive()) {
                ...
                GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mTextures.get(mActivity.ModelNumber).mTextureID[0]);
            ...
            if(mActivity.var.var == 0){
                mActivity.var.setVar(1);
                ...
                thread.start();
                Log.e("TEXTURE", mActivity.var.var+"");
            }
    ...
    public void selectTextures(int num)
    {
